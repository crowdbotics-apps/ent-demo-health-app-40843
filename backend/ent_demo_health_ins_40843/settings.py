"""
Django settings for ent_demo_health_ins_40843 project.
...
INSTALLED_APPS = [
    ...
    'django.contrib.sites', "appointment"
]
LOCAL_APPS = [
    'home',
...
ROOT_URLCONF = 'ent_demo_health_ins_40843.urls'
...
WSGI_APPLICATION = 'ent_demo_health_ins_40843.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ent_demo_health_ins_40843 API",
    "DESCRIPTION": "API documentation for ent_demo_health_ins_40843 App",
    "VERSION": "v1",
}
