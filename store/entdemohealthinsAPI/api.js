...
function api_v1_callcenter_update(payload) {
  return entdemohealthinsAPI.put(`/api/v1/callcenter/${payload.id}/`, payload.data);
}

function api_v1_callcenter_partial_update(payload) {
  return entdemohealthinsAPI.patch(`/api/v1/callcenter/${payload.id}/`, payload.data);
}
...
function rest_auth_password_reset_confirm_create(payload) {
  return entdemohealthinsAPI.post(`/rest-auth/password/reset/confirm/`, payload.data);
}

function rest_auth_registration_verify_email_create(payload) {
  return entdemohealthinsAPI.post(`/rest-auth/registration/verify-email/`, payload.data);
}
